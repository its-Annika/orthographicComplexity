...
python3 convert.py $12.5HourTrain.txt $1ASR_Files
python3 convert.py $15HourTrain.txt $1ASR_Files
python3 convert.py $110HourTrain.txt $1ASR_Files
python3 convert.py $11HourDev.txt $1ASR_Files
python3 convert.py $11HourTest.txt $1ASR_Files
